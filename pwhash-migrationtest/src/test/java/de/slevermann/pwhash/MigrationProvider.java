...
public class MigrationProvider {
    ...
    private HashStrategy[] customStrategies = new HashStrategy[]{
            Argon2idStrategy.getInstance(CUSTOM_ARGON2_MEMORY_COST, Argon2Strategy.DEFAULT_PARALLELISM,
                    Argon2Strategy.DEFAULT_TIME_COST, Argon2Strategy.DEFAULT_SALT_LENGTH,
                    Argon2Strategy.DEFAULT_HASH_LENGTH),
            Argon2idStrategy.getInstance(Argon2Strategy.DEFAULT_MEMORY_COST, CUSTOM_ARGON2_PARALLELISM,
                    Argon2Strategy.DEFAULT_TIME_COST, Argon2Strategy.DEFAULT_SALT_LENGTH,
                    Argon2Strategy.DEFAULT_HASH_LENGTH),
            Argon2idStrategy.getInstance(Argon2Strategy.DEFAULT_MEMORY_COST, Argon2Strategy.DEFAULT_PARALLELISM,
                    CUSTOM_ARGON2_TIME_COST, Argon2Strategy.DEFAULT_SALT_LENGTH,
                    Argon2Strategy.DEFAULT_HASH_LENGTH),

            Argon2iStrategy.getInstance(CUSTOM_ARGON2_MEMORY_COST, Argon2Strategy.DEFAULT_PARALLELISM,
                    Argon2Strategy.DEFAULT_TIME_COST, Argon2Strategy.DEFAULT_SALT_LENGTH,
                    Argon2Strategy.DEFAULT_HASH_LENGTH),
            Argon2iStrategy.getInstance(Argon2Strategy.DEFAULT_MEMORY_COST, CUSTOM_ARGON2_PARALLELISM,
                    Argon2Strategy.DEFAULT_TIME_COST, Argon2Strategy.DEFAULT_SALT_LENGTH,
                    Argon2Strategy.DEFAULT_HASH_LENGTH),
            Argon2iStrategy.getInstance(Argon2Strategy.DEFAULT_MEMORY_COST, Argon2Strategy.DEFAULT_PARALLELISM,
                    CUSTOM_ARGON2_TIME_COST, Argon2Strategy.DEFAULT_SALT_LENGTH,
                    Argon2Strategy.DEFAULT_HASH_LENGTH),

            Argon2dStrategy.getInstance(CUSTOM_ARGON2_MEMORY_COST, Argon2Strategy.DEFAULT_PARALLELISM,
                    Argon2Strategy.DEFAULT_TIME_COST, Argon2Strategy.DEFAULT_SALT_LENGTH,
                    Argon2Strategy.DEFAULT_HASH_LENGTH),
            Argon2dStrategy.getInstance(Argon2Strategy.DEFAULT_MEMORY_COST, CUSTOM_ARGON2_PARALLELISM,
                    Argon2Strategy.DEFAULT_TIME_COST, Argon2Strategy.DEFAULT_SALT_LENGTH,
                    Argon2Strategy.DEFAULT_HASH_LENGTH),
            Argon2dStrategy.getInstance(Argon2Strategy.DEFAULT_MEMORY_COST, Argon2Strategy.DEFAULT_PARALLELISM,
                    CUSTOM_ARGON2_TIME_COST, Argon2Strategy.DEFAULT_SALT_LENGTH,
                    Argon2Strategy.DEFAULT_HASH_LENGTH),

            BCryptStrategy.getInstance(CUSTOM_BCRYPT_WORKFACTOR),
